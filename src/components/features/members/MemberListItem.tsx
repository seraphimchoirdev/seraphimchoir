...
const PART_COLORS: Partial<Record<Part, string>> = {
    SOPRANO: 'text-purple-600 bg-purple-50 border-purple-200',
    ALTO: 'text-yellow-600 bg-yellow-50 border-yellow-200',
    TENOR: 'text-blue-600 bg-blue-50 border-blue-200',
    BASS: 'text-green-600 bg-green-50 border-green-200',
};
...
export default function MemberListItem({ member, onDelete }: MemberListItemProps) {
    ...
    return (
        <>
            <div className="bg-white border border-gray-200 rounded-lg p-3 flex items-center justify-between hover:bg-gray-50 transition-colors">
