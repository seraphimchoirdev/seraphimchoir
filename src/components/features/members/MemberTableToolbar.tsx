...
import { ArrowUpDown, Check, Clock, PlusCircle, X } from 'lucide-react';
...
export function MemberTableToolbar({
  ...
  return (
    <div className="flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
      <div className="flex flex-1 flex-col gap-2 space-x-2 sm:flex-row sm:items-center">
        <Input
          placeholder="이름 검색..."
          value={searchTerm}
        ...
        <div className="flex gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-[200px]">
              ...
              <DropdownMenuSeparator />
              <div>
                <DropdownMenuItem onClick={() => onPartChange('ALL')} className="justify-between">
                  전체
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-[200px]">
              ...
              <DropdownMenuSeparator />
              <div>
                <DropdownMenuItem onClick={() => onStatusChange('ALL')} className="justify-between">
                  전체
              ...
              <Button variant="outline" size="sm" className="h-8 border-dashed">
                ...
                {(absentDaysService || absentDaysPractice) && (
                  <>
                    ...
                    <Badge
                      variant="secondary"
                      className="rounded-sm px-1 font-normal text-[var(--color-warning-700)]"
                    >
                      {absentDaysService
