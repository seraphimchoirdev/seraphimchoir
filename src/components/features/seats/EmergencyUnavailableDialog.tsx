...
import type { EmergencyUnavailableDialogProps, UnavailableProcessMode, CascadeChangeStep } from '@/types/emergency-changes';
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[500px]">
                ...
                <div className="space-y-2">
                    <h4 className="text-sm font-medium text-muted-foreground">처리 방식 선택</h4>
                ...
                {/* 미리보기 */}
                <div className="space-y-2">
                    <h4 className="text-sm font-medium text-muted-foreground">예상 변동 사항</h4>
                ...
                {/* 경고 메시지 */}
                <div className="flex items-start gap-2 text-amber-600 bg-amber-50 dark:bg-amber-950/30 rounded-lg p-3">
                    <AlertTriangle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                    <span className="text-xs">
                        출석 상태도 &apos;등단 불가&apos;로 변경됩니다.
                    </span>
                </div>
