...
import { ArrowRight, Clock, Database, RefreshCw, Users } from 'lucide-react';
    ...
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>저장하지 않은 작업이 있습니다.</DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-3 py-4">
          ...
          {/* DB 데이터 존재 시 안내 */}
          {hasDbData && (
            <div className="flex items-start gap-2 rounded-lg bg-[var(--color-background-tertiary)] p-3 text-xs text-[var(--color-text-tertiary)]">
