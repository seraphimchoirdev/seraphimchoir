...
import { useDeleteArrangement } from '@/hooks/useArrangements';
...
export default function ArrangementList({ arrangements }: ArrangementListProps) {
    ...
    const handleDeleteClick = (e: React.MouseEvent, arrangement: Arrangement) => {
        e.preventDefault();
        e.stopPropagation();
        ...
        <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {arrangements.map((arrangement) => (
                    <Card key={arrangement.id} className="h-full transition-all duration-200 hover:shadow-md hover:border-[var(--color-primary-400)] group">
                        ...
                        <CardContent className="pb-3 space-y-2">
                            ...
                            {arrangement.service_info && (
                                <div className="flex items-start text-sm text-[var(--color-text-secondary)]">
                                    ...
                                    <span className="line-clamp-2">{arrangement.service_info}</span>
                                </div>
                            )}
                        </CardContent>
                        <CardFooter className="pt-3 border-t border-[var(--color-border-default)] flex-col gap-3">
                            ...
                            <div className="w-full flex gap-2">
                                ...
                                <Button
                                    ...
                                    onClick={(e) => handleDeleteClick(e, arrangement)}
                                >
            ...
            <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            정말 &quot;{selectedArrangement?.title}&quot; 배치표를 삭제하시겠습니까?
                            <br />
