...
export default function CreateArrangementDialog({
  ...
  const handleScheduleSelect = (scheduleId: string) => {
    ...
    if (schedule) {
      ...
      if (schedule.offertory_performer)
        serviceInfoParts.push(`봉헌송: ${schedule.offertory_performer}`);
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Alert>
                ...
                <AlertDescription>
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-1 text-[var(--color-primary-600)] hover:underline"
                  >
                    예배 일정 관리
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={createArrangement.isPending || !selectedScheduleId}>
              {createArrangement.isPending && <Loader2 className="mr-2 h-4 w-4 animate-spin" />}
              생성하기
            </Button>
          </DialogFooter>
        </form>
