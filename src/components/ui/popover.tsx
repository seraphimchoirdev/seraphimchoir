...
export const PopoverContent = React.forwardRef<HTMLDivElement, PopoverContentProps>(
  ({ className = '', children, align = 'center' }, forwardedRef) => {
    ...
    return (
      <div
        ref={ref}
        className={`absolute z-50 mt-2 min-w-[200px] rounded-[var(--radius-base)] border border-[var(--color-border-default)] bg-[var(--color-background-primary)] shadow-[var(--shadow-md)] ${alignmentClass} ${className} `}
      >
        {children}
      </div>
    );
