...
import { cn } from '@/lib/utils'; // Assuming cn utility exists, standard in shadcn/ui projects
...
export function Heading({ level, ...props }: { level: 1 | 2 | 3 | 4 } & Omit<TypographyProps, 'variant'>) {
