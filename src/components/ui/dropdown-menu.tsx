...
>(({ className, asChild = false, ...props }, ref) => {
  const itemStyles =
    'relative flex cursor-pointer select-none items-center rounded-[var(--radius-sm)] px-2 py-1.5 text-sm outline-none transition-colors focus:bg-[var(--color-background-tertiary)] focus:text-[var(--color-text-primary)] data-[disabled]:pointer-events-none data-[disabled]:opacity-50 hover:bg-[var(--color-background-tertiary)]';
  ...
  return <div ref={ref} className={cn(itemStyles, className)} {...props} />;
});
