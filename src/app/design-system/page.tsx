...
export default function DesignSystemPage() {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-7xl space-y-12 bg-[var(--color-background-primary)] p-8">
      {/* Header */}
      <div className="space-y-4 border-b border-[var(--color-border-default)] pb-8">
      ...
      <DesignSystemSection
        title="타이포그래피"
        description="시스템에서 사용되는 텍스트 스타일입니다."
      >
          ...
          <div className="grid gap-4">
            ...
            <div className="space-y-1">
              <Text variant="caption">
                Caption - 찬양하는 마음으로 하나님을 섬기는 새로핌찬양대
              </Text>
      ...
      <DesignSystemSection
        title="색상 팔레트"
        description="브랜드 아이덴티티를 반영한 색상 시스템입니다."
      >
      ...
      <DesignSystemSection title="버튼">
        <div className="space-y-8">
          ...
          <div>
            <Heading level={4} className="mb-4">
              색상 팔레트 Variants (Bold)
            </Heading>
            <Text variant="body-small" className="mb-3 text-[var(--color-text-secondary)]">
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <Text variant="label" className="text-[var(--color-success-600)]">
                    95%
                  </Text>
                </div>
              </div>
      ...
      <DesignSystemSection title="그라데이션">
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <div
            className="flex h-32 items-center justify-center rounded-lg border border-[var(--color-border-default)]"
          ...
          >
            <Heading level={3} className="text-[var(--color-primary-700)]">
              Primary Subtle
            </Heading>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-6 md:grid-cols-3">
          {['xs', 'sm', 'base', 'md', 'lg', 'xl'].map((size) => (
            <div key={size} className="space-y-2">
              <div
                className="flex h-24 items-center justify-center rounded-lg bg-white"
