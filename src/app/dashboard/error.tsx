...
const logger = createLogger({ prefix: 'DashboardError' });
  ...
  return (
    <div className="flex min-h-[400px] flex-col items-center justify-center p-8">
      <div className="max-w-md text-center">
        ...
        <h1 className="mb-2 text-2xl font-bold text-gray-900">대시보드 오류</h1>

        <p className="mb-6 text-gray-600">대시보드를 불러오는 중 문제가 발생했습니다.</p>
