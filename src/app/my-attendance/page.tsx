...
import { AlertTriangle, Calendar, CheckCircle, Clock, Loader2, XCircle } from 'lucide-react';
...
import { getTimeUntilDeadline, useUpcomingVoteDeadlines } from '@/hooks/useVoteDeadlines';
        ...
        <div className="container mx-auto max-w-2xl px-4 py-8">
          ...
          {isLoading ? (
            ...
            <div className="py-12 text-center">
              ...
              <p className="text-[var(--color-text-secondary)]">다가오는 예배 일정이 없습니다.</p>
            </div>
          ) : (
                    ...
                    <div className="flex items-start justify-between">
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="rounded-full bg-[var(--color-background-tertiary)] px-2 py-0.5 text-sm text-[var(--color-text-secondary)]">
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          disabled={
                            isPassed || createMutation.isPending || updateMutation.isPending
                          }
          ...
          {/* 안내 문구 */}
          <div className="mt-8 rounded-lg border border-[var(--color-border)] bg-[var(--color-background-secondary)] p-4">
