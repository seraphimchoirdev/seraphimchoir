...
### 2026-09-07
- [x] **docs(handoff): 2026-09-07 세션 핸드오프 추가**

- [x] **fix(handoff): 매니페스트를 결정론적으로 생성해 노이즈 diff 제거**

- [x] **refactor(service-schedules): 일괄 등록 미리보기를 읽기 중심 편집으로 전환**


- [x] **feat(service-schedules): 일괄 등록을 전용 페이지로 전환하고 기타 예배 유형 추가**

### 2026-09-03

- [x] **fix(members): 재승격 시 최초 정대원 임명일이 덮이던 문제 수정**

### 2026-08-18
- [x] **feat(members): 신입대원 연습 세트 집계·승격 (5~6단계)**


- [x] **feat(members): 신입대원 연습 세트 기록 (1~4단계)**

### 2026-07-29
- [x] **fix(service-schedules): 예배 전 연습 시각 누락 보정 및 저장 경로 연결**


- [x] **fix(service-schedules): 주일 2부 예배 외 예배의 예배 후 연습 설정 정합성 복구**
